...
def set_disk_guid(num, guid):
    ...
    if rc == 0 and 'OK' in out:
        return 0, ''
    if 'accesso negato' in out.lower() or 'access denied' in out.lower() or 'unauthorized' in out.lower():
        return rc, 'ANTIVIRUS BLOCKING: Temporarily disable ALL antivirus (including third-party) and Windows Defender real-time protection. Then retry.'
...
if __name__ == '__main__':
    ...
    try:
        ...
        print('Defender exclusion error:', e)
    home()
